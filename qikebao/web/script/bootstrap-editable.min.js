...
!function(a){
  $.fn.editableform.buttons =
      '<button type="submit" class="icon btn btn-primary btn-sm editable-submit">'+
        '<i class="iconfont icon-select"></i>'+
      '</button>'+
      '<button type="button" class="icon btn btn-default btn-sm editable-cancel">'+
        '<i class="iconfont icon-close"></i>'+
      '</button>';

  $.fn.editable.defaults.emptytext = "点击设置";

  $.fn.bdatepicker.dates['zh-CN'] = {
